...
# This can be set up in a way that filters the status of the user in the get_org_members function
...
def main():
  ...
  #Search through all members in the list and remove all revoked users
